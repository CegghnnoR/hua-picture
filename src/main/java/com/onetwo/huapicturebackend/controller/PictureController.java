...
import com.onetwo.huapicturebackend.common.DeleteRequest;
import com.onetwo.huapicturebackend.common.ResultUtils;
import com.onetwo.huapicturebackend.constant.UserConstant;
...
import com.onetwo.huapicturebackend.model.dto.picture.*;
...
import com.onetwo.huapicturebackend.model.vo.PictureTagCategory;
...
//    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        if (cachedValue != null) {
            // 如果缓存命中，返回结果
            Page<PictureVO> cachedPage = JSONUtil.toBean(cachedValue, new TypeReference<Page<PictureVO>>() {
            }, false);
